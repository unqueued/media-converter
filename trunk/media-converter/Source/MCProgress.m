...
@implementation MCProgress

- (id)init
{
	self = [super init];
	
	notificationNames = [[NSArray alloc] initWithObjects:@"MCMaximumValueChanged", @"MCValueChanged", @"MCTaskChanged", @"MCStatusChanged", @"MCStatusByAddingPercentChanged", @"MCCancelNotificationChanged", nil];
...
- (void)setMaximumValue:(NSNumber *)number
{
	...
	else
	{
		...
		application = [[NSImage imageNamed:@"Media Converter"] copy];
